...
public class RSAUtil {
    ...
    public static String publicEncrypt(final String data, final String publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public static String privateDecrypt(final String data, final String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
